...
include 'koneksi.php';
//total stok
$total_item = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM product"));
...
$total_stok_kritis = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM product WHERE stock <= min_stock"));
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Laporan - Inventory Rasya</title>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/logo2.jpeg" alt="Profile" class="rounded-circle">
