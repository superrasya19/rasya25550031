...
<head>
  ...
  <title>Manajemen Users - inventory rasya</title>
...
<body>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body mt-3">
              <a href="t_user.php" class="btn btn-primary"> Tambah Users</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://www.instagram.com/najwaluthfii/">RasyaAndi</a>
    </div>
  </footer><!-- End Footer -->
